...
const supabaseUrl = import.meta.env.PUBLIC_SUPABASE_URL ?? Deno.env.get("PUBLIC_SUPABASE_URL")
const supabaseAnonKey = import.meta.env.PUBLIC_SUPABASE_ANON_KEY ?? Deno.env.get("PUBLIC_SUPABASE_ANON_KEY")
